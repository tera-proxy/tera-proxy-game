...
class DispatchWrapper {
	constructor(dispatch, moduleName) {
		...
		this[kSettings] = new Settings(path.join(proxyRoot, 'settings', this.moduleName + '.json'), this.moduleName)
	}
	...
	hook(...args) { return this.dispatch.hook(this.moduleName, ...args) }
